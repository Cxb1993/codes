...
void filerAllSol(int timeStep)
{
    ...
    {
        filer2(U, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_U-final");
        filer2(V, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_V-final");
        filer2(P, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_P-final");
    }
    else
    {
        ...
        filer2(U, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_U-" + timeStr);
        filer2(V, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_V-" + timeStr);
        filer2(P, nx, ny,
               "ny=" + to_string(ny) + "_" + velScheme + "_P-" + timeStr);
    }
}

void progressFileCreator()
{
    progressFile.open(filePath + "ny=" + to_string(ny) + "_" + velScheme
           + "_logProgress" + fileExt);
}

void progressFiler()
{
    // progressFile.open(filePath + "_ny=" + to_string(ny) + "_" + velScheme +
    //     "_logProgress" + fileExt, ios_base::app);    // open for editing
...
{
    ofstream f;
    f.open(filePath + "ny=" + to_string(ny) + "_" + velScheme
           + "_logCharacteristics" + fileExt);

    // Write heading and column headers
    f << left << "Finite Volume Method case for 2D flow inside a pipe\n";
    f << endl;
    ...
    f << setw(15) << "pInitial" << pInitial << " Pa\n";
    ...
    f << setw(15) << "Running time" << scriptRunningTime << " minutes\n";
    f << endl;
}
