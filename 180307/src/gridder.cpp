...
void gridder()
{
    ...
    Y[0]    = Y[1];
    Y[ny]   = Y[ny-1];
    filer1(X, (nx+1), filePath + "ny=" + to_string(ny) + "_coordinateX");
    filer1(Y, (ny+1), filePath + "ny=" + to_string(ny) + "_coordinateY");
    ...
    filer1(Dx, (nx+1), filePath + "ny=" + to_string(ny) + "_coordinateDx");
    filer1(Dxs, (nx+1), filePath + "ny=" + to_string(ny) + "_coordinateDxs");
    ...
    filer1(Dy, (ny+1), filePath + "ny=" + to_string(ny) + "_coordinateDy");
    filer1(Dys, (ny+1), filePath + "ny=" + to_string(ny) + "_coordinateDys");
}
