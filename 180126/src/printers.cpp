...
void infoPrinter()
{
    ...
    cout << setw(15) << "uAvg" << uAvg << "\n";
    cout << setw(15) << "pavg_inlet" << pavg_inlet << "\n";
    cout << setw(15) << "pavg_outlet" << pavg_outlet << "\n";
    cout << setw(15) << "deltaP" << deltaP << "\n\n";

    // Print case characteristics
    cout << "Case characteristics\n";
    cout << setw(15) << "velScheme" << velScheme << "\n";
    cout << setw(15) << "Re" << Re << "\n";
    cout << setw(15) << "entryLength" << entryLength << "\n";
