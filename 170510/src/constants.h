...
const double maxTimesteps = 100;     // max time iterations
const double maxPressIterations = 100; // max pressure iterations
const double pressResidual = 1.0e-4;    // residual criteria for pressure
