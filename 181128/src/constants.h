...
const int nd = 20;                      // grid dimension
...
const std::string fileUniqueName = "testDFIB_20_10";
                                        // optional unique identifier
const std::string comments =
"Testing development of DFIB step by step; velocity corrected";
