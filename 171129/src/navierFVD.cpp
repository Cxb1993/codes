...
double U[nx-1][ny-1]    = { {0.0} };
double V[nx-1][ny-1]    = { {0.0} };
double Ur[nx-1][ny-1]   = { {0.0} };
double Vr[nx-1][ny-1]   = { {0.0} };
double Uo[nx-1][ny-1]   = { {0.0} };
double Vo[nx-1][ny-1]   = { {0.0} };
double FU[nx-1][ny-1]   = { {0.0} };
double FV[nx-1][ny-1]   = { {0.0} };
double FUo[nx-1][ny-1]  = { {0.0} };
double FVo[nx-1][ny-1]  = { {0.0} };
double P[nx-1][ny-1]    = { {0.0} };
...
void velBoundary()
{
    ...
    for (int i = 0; i < nx-1; ++i)
    {
        U[i][ny-2] = -U[i][ny-3];       // Dirichlet
        // U[i][ny-2] = -U[i][ny-3] + 2*uin;       // Dirichlet
        V[i][ny-2] = 0.0;               // Dirichlet
    }
    // Bottom boundary
    for (int i = 0; i < nx-1; ++i)
    {
    ...
    for (int j = 0; j < ny-1; ++j)
    {
        U[nx-2][j] = U[nx-3][j];        // Neumann
        V[nx-2][j] = V[nx-3][j];        // Neumann
    }
}
