...
constexpr int ny = 1000;                // although "const" is also sufficient; also, it must be an even number for compatibility with navierAnaltical()
...
const int maxPressIters = 10;           // max pressure iterations
...
const double pResidual = 1.0e-2;        // residual criteria for pressure
const double dt = 1.0e-7;               // time-step
...
// Display variables for displaying information during solution
extern int iterP;
extern double changeP;
extern double changeU;
