...
void filerAllSol(const int timeStep)
{
    ...
    {
        filer2(U, nx, ny,
                "nxy=" + to_string(nxy) + fileUniqueName + "_" + velScheme
                + "_U-final");
        filer2(V, nx, ny,
                "nxy=" + to_string(nxy) + fileUniqueName + "_" + velScheme
                + "_V-final");
...
{
    progressFile.open(filePath + "nxy=" + to_string(nxy) + fileUniqueName + "_"
...
{
    ofstream f;
    f.open(filePath + "nxy=" + to_string(nxy) + fileUniqueName + "_"
