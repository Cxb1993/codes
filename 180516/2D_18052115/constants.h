...
// String variables
const std::string velScheme = "qk";     // where "up" is upwind, "qk" is QUICK
                                        // and "ct" is central scheme
const std::string filePath = "../data/";
const std::string fileUniqueName = "test";
                                        // optional unique identifier
const std::string comments = "Testing";
...
extern int mChangeMax_k;
extern int pChangeMax_i;
extern int pChangeMax_j;
extern int pChangeMax_k;
extern int uChangeMax_i;
extern int uChangeMax_j;
extern int uChangeMax_k;
extern int vChangeMax_i;
extern int vChangeMax_j;
extern int vChangeMax_k;
extern int wChangeMax_i;
extern int wChangeMax_j;
extern int wChangeMax_k;
