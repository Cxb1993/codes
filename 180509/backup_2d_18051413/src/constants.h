...
const int maxTimesteps = 1e5;           // max time iterations
...
const std::string fileUniqueName = "final18051412";
                                        // optional unique identifier
const std::string comments = "2D final version as on 2018-05-14";
