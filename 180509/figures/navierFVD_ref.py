...
def cavityPlotterU(nm, name, lineStyle):
    ...
    plt.plot(uy[2:-2], yi, label=plotLabel, linestyle=lineStyle)
...
def cavityPlotterV(nm, name, lineStyle):
    ...
    plt.plot(xi, vx[2:-2], label=plotLabel, linestyle=lineStyle)
...
# compareVelProfilesCavityFlow(41, ['test', 'benchmark180502'], ['-', '--'])
# uContours(nxy, "qk")
# vContours(nxy, "qk")
# velVectors(nxy, "qk")
