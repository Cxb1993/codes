...
def uRepeater(nxy, fileUniqueName):
    ...
    # # For plotting the horizontal grid lines
...
# uRepeater(81, fileUniqueName)   # incomplete results
...
def vRepeater(nxy, fileUniqueName):
    ...
    # # For plotting the vertical grid lines
    # xv, yv = np.meshgrid(xi, vm)
    # linesx = plt.plot(xv, yv)
    # for lines in [linesx]:
    #     for line in lines:
    #         line.set_lw(0.2)
...
# vRepeater(81, fileUniqueName)   # incomplete results
