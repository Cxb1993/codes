...
void detEtaRC()
{
    ...
    ifstream airfoil;
    airfoil.open("airfoil.txt");
    string row1;
    int I=0 ;
    while (getline(airfoil,row1))
    {
        stringstream ssairfoil(row1);
        ssairfoil >> Sx[I];
        I++;
    }

    ifstream airfoily;
    airfoily.open("airfoily.txt");
    string row2;
    int J=0 ;
    while (getline(airfoily,row2))
    {
        stringstream ssairfoily(row2);
        ssairfoily >> Sy[J];
        J++;
    }
/*
